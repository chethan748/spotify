...
async function main(){
  ...
  for (const song of songs) {
    ...
    songsul.innerHTML= songsul.innerHTML+ ` <li>
                    ...
                    <span> <p>${song.replaceAll("%20", " ").replaceAll("%26"," ").replaceAll("V%2C"," ").replaceAll(".mp3"," ").slice(0,19)}</p></span>
...
main()
{/* <li>${song.replaceAll("%20", " ").replaceAll("%26"," ").replaceAll("V%2C"," ").replaceAll(".mp3"," ").slice(0,1)}</li>`; */}
